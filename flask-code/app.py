...
@app.route('/joineando-del-verbo-join/room/roomunavailablility/<int:roomid>', methods = ['POST', 'DELETE'])
...
@app.route('/joineando-del-verbo-join/users/stats/mostreservations', methods = ['GET'])
